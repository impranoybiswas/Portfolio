        ...
        <div
            ...
            >
              ...
              <div className=" w-full space-y-4">
                ...
                <p className="text-gray-100 text-center">This website is my frist NextJS Project. I made it using stack below :</p>
        
                {/* Tech Stack Badges */}
                <div className="flex flex-wrap gap-2 mt-4 justify-center">
                  <span className={`flex items-center gap-1 px-3 py-1 rounded-md shadow-sm text-sm
                    bg-gray-800 text-white `}
                  ><RiNextjsLine /> Next JS</span>
                  <span className={`flex items-center gap-1 px-3 py-1 rounded-md shadow-sm text-sm
                    text-blue-500 bg-blue-100 `}
                  ><SiTypescript /> TypeScript</span>
                  <span className={`flex items-center gap-1 px-3 py-1 rounded-md shadow-sm text-sm
                    text-sky-600 bg-sky-50 `}
                  ><SiTailwindcss /> TailwindCSS</span>
                  <span className={`flex items-center gap-1 px-3 py-1 rounded-md shadow-sm text-sm
                    text-amber-600 bg-amber-50 `}
                  ><SiDaisyui /> DaisyUI</span>
