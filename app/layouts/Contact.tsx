    ...
    <Section name="contact" title="" subtitle="">
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-10 relative">
        ...
        <div className="w-full flex flex-col items-center justify-between">
          ...
          <SocialLinks />
          <div className="hidden justify-center items-center w-auto h-auto rounded-md p-[2px] relative overflow-hidden">
            <div className="bg-gradient-to-b via-primary/40 to-transparent from-transparent h-full w-full rounded-md z-10 scale-150 absolute top-0 left-0 animate-slowSpin" />
