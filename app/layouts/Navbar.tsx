...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { name: t("skills"), path: "skills", icon: <CodeXml size={20} /> },
    { name: "", path: "home", icon: <House size={20} /> },
    { name: t("projects"), path: "projects", icon: <FolderGit size={20} /> },
    { name: t("contact"), path: "contact", icon: <AtSign size={20} /> },
  ];
  return (
    <motion.nav
