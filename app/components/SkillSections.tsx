      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-5 items-center justify-center w-full">
        {skills.map((item, i) => (
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-3 lg:gap-4 bg-base-200 backdrop-blur-xl hover:bg-base-100/90 p-4 rounded-xl group relative z-10">
              <div
