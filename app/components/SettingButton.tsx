  ...
  return (
    <Modal label={<IoSettingsOutline />} title="Customization">
      <div className="flex flex-col gap-5 bg-background text-foreground text-lg">
        <div className="flex items-center justify-between bg-base-200/50 border border-foreground/5 rounded-xl p-5">
          <p>Theme</p>
          <ThemeToggle />
        </div>
        <div className="flex flex-col items-start justify-between bg-base-200/50 border border-foreground/5 rounded-xl p-5">
