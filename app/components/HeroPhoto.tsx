  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-gradient-to-r from-indigo-500/0 via-purple-500/10 to-purple-400 rounded-full size-52 md:size-82 lg:size-102 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
      />
